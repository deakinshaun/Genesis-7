...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Drawing_Attached_m6DE3736C6FA7E055E43A6922C299DC4D9E622CDA (Drawing_t8A457FA9D4D22521773160B84F3332A896BF0918* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_2);
		InterfaceActionInvoker1< Action_tD00B0A84D7945E50C2DFFC28EFEE6ED44ED2AD07* >::Invoke(2 /* System.Void Photon.Bolt.IPlayerState1::set_OnDraw(System.Action) */, IPlayerState1_t18610C8865CC13F8C602B8B38FC6B2015190B1C4_il2cpp_TypeInfo_var, L_2, L_3);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void LaserActivation_Attached_mC578B82ABF0BA6CE69888CC7C3F4E2ADAB81BABC (LaserActivation_t05D1BA768E4C44E1DAABE1BE293396D647242FE4* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_0 = __this->___lasers_5;
		NullCheck(L_0);
		...
		NullCheck(L_2);
		Action__ctor_mBDC7B0B4A3F583B64C2896F01BDED360772F67DC(L_2, __this, (intptr_t)((void*)LaserActivation_Lasers_mB5A6AC3C1916A070361E698201BE8A4516F38D73_RuntimeMethod_var), NULL);
		NullCheck(L_1);
		InterfaceActionInvoker1< Action_tD00B0A84D7945E50C2DFFC28EFEE6ED44ED2AD07* >::Invoke(2 /* System.Void Photon.Bolt.IPlayerState1::set_OnDraw(System.Action) */, IPlayerState1_t18610C8865CC13F8C602B8B38FC6B2015190B1C4_il2cpp_TypeInfo_var, L_1, L_2);
		// state.OnDraw = LasersR;
		RuntimeObject* L_3;
		L_3 = EntityBehaviour_1_get_state_m32C34CDF233992CFD6B0880BE1FE40B94FB97BFB(__this, EntityBehaviour_1_get_state_m32C34CDF233992CFD6B0880BE1FE40B94FB97BFB_RuntimeMethod_var);
		...
		NullCheck(L_4);
		Action__ctor_mBDC7B0B4A3F583B64C2896F01BDED360772F67DC(L_4, __this, (intptr_t)((void*)LaserActivation_LasersR_mC601BC4EC81473CD716E25B826593ED2FF67E881_RuntimeMethod_var), NULL);
		NullCheck(L_3);
		InterfaceActionInvoker1< Action_tD00B0A84D7945E50C2DFFC28EFEE6ED44ED2AD07* >::Invoke(2 /* System.Void Photon.Bolt.IPlayerState1::set_OnDraw(System.Action) */, IPlayerState1_t18610C8865CC13F8C602B8B38FC6B2015190B1C4_il2cpp_TypeInfo_var, L_3, L_4);
		// }
		return;
	}
}
